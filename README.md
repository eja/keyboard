...
The entire project is **less than 200 lines of code**, making it extremely lightweight and easy to audit for security.
...
*   **Auditable:** With a codebase under 200 LOC, read the source code in minutes to verify exactly what it does.
